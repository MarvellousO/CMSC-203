...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    //  where row is the index of the array's current row
    //  and column is the index of the array's current column
	   // Nested loop to iterate over the columns in the specified row
	    for (int column = 0; column < intArray[row].length; column++) {
	        // Set the element to the specified value
   ...
   */
   public int findMinimum( int column )
   {
	...
	// Get the first element in the specified column
	    int minimum = intArray[0][column];

	    // Loop through the rows to find the minimum value in the specified column
   ...
   public int countFound( int value )
   {
    ...
    //        num is the local variable storing the current frequency count
	   // Initialize the count of occurrences
	    ...
	    // Loop through the array to count occurrences of the given value
	    for (int row = 0; row < intArray.length; row++) {
	        for (int column = 0; column < intArray[row].length; column++) {
	    ...
	    // Return the total count of occurrences of the given value in the array
	    return count;
   }
